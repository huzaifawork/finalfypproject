...
const MyReservations = () => {
  ...
  const fetchReservations = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get("https://finalfypproject-k248prfl1-huzaifas-projects-eabfae35.vercel.app/api/reservations/user", {
  ...
  const handleCancelReservation = async (reservationId, reservationDate) => {
    ...
    try {
      setLoading(true);
      await axios.delete(`https://finalfypproject-k248prfl1-huzaifas-projects-eabfae35.vercel.app/api/reservations/${reservationId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
